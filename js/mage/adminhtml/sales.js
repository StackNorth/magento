...
AdminOrder.prototype = {
    ...
    discountFormsubmit : function(creditNumber){
        this.loadArea(['items', 'shipping_method', 'totals', 'billing_method'], true, {'order[use_credit_amount]':creditNumber, reset_shipping: true});
    },

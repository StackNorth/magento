...
(1, 'robin', 'fu', 'robinfu@shtag.com', 'admin', 'ac809ab74aa2ab3fc565760660deb104:nJZ5PlgmMiVEfNLufSEDsQQVrRsYna7n', '2014-06-27 16:12:05', '2014-06-27 16:12:05', '2014-06-28 18:24:10', 3, 0, 1, 'N;', NULL, NULL);
...
(1, 1, 1, 'sku001|William Saurin|Shanghai|Afternoon 2:00-14:30|无|Child|asdf nlasd fnlasdf nlasfdn lasfn lsadfnl sanflas fnlsanfd lasnf lnsafd nlsd fnlsafd nlsadf nlsadf nlasd f|df nlasd fnlasdf nlasfdn lasfn lsadfnl sanflas fnlsanfd lasnf lnsafd nlsd fnlsafd nlsadf nlsadf|380|2014-6-29|1');
...
(3, 3, 3, 2, '2014-06-28 20:04:16', '2014-06-28 20:04:40', '1/2/3', 1, 2, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Category Integer Attribute Backend Table' AUTO_INCREMENT=14 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Category Text Attribute Backend Table' AUTO_INCREMENT=14 ;
...
(1, 4, 4, 'virtual', 'sku001', 0, 0, '2014-06-28 20:01:25', '2014-06-28 20:01:25');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Datetime Attribute Backend Table' AUTO_INCREMENT=8 ;
...
(2, 4, 93, 0, 1, NULL),
(3, 4, 94, 0, 1, NULL),
(4, 4, 77, 0, 1, '2014-06-29 00:00:00'),
(5, 4, 78, 0, 1, NULL),
(6, 4, 104, 0, 1, NULL),
(7, 4, 105, 0, 1, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Decimal Attribute Backend Table' AUTO_INCREMENT=4 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Integer Attribute Backend Table' AUTO_INCREMENT=8 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Catalog Product Varchar Attribute Backend Table' AUTO_INCREMENT=21 ;
...
--
-- 转存表中的数据 `aca_catalog_product_index_eav_tmp`
--

INSERT INTO `aca_catalog_product_index_eav_tmp` (`entity_id`, `attribute_id`, `store_id`, `value`) VALUES
(1, 133, 1, 7),
(1, 140, 1, 12),
(1, 138, 1, 8),
(1, 121, 1, 0);
...
(1, 0, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL),
(1, 1, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL),
(1, 2, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL),
(1, 3, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL);
...
--
-- 转存表中的数据 `aca_catalog_product_index_price_tmp`
--

INSERT INTO `aca_catalog_product_index_price_tmp` (`entity_id`, `customer_group_id`, `website_id`, `tax_class_id`, `price`, `final_price`, `min_price`, `max_price`, `tier_price`, `group_price`) VALUES
(1, 0, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL),
(1, 1, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL),
(1, 2, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL),
(1, 3, 1, 0, '380.0000', '280.0000', '280.0000', '280.0000', NULL, NULL);
...
(133, 4, 'chef', NULL, NULL, 'int', NULL, NULL, 'select', '厨师', NULL, 'eav/entity_attribute_source_table', 0, 1, '', 0, NULL),
(134, 4, 'seats', NULL, NULL, 'varchar', NULL, NULL, 'text', '座位数', NULL, NULL, 0, 1, NULL, 0, NULL),
...
(137, 4, 'class_date', NULL, 'eav/entity_attribute_backend_datetime', 'datetime', NULL, 'eav/entity_attribute_frontend_datetime', 'date', '课程日期', NULL, NULL, 0, 1, NULL, 0, NULL),
(138, 4, 'class_section', NULL, NULL, 'int', NULL, NULL, 'select', '课程时间段', NULL, 'eav/entity_attribute_source_table', 0, 1, '', 0, NULL),
(139, 4, 'class_address', NULL, NULL, 'varchar', NULL, NULL, 'text', '课程地址', NULL, NULL, 0, 1, NULL, 0, NULL),
(140, 4, 'province', NULL, NULL, 'int', NULL, NULL, 'select', '省份', NULL, 'eav/entity_attribute_source_table', 0, 1, '', 0, NULL);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Eav Attribute Label' AUTO_INCREMENT=25 ;
...
(18, 136, 1, 'Requirement'),
(21, 133, 1, 'chef'),
(22, 139, 1, '课程地址'),
(23, 137, 1, 'Class Date'),
(24, 135, 1, 'western cuisine');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Eav Attribute Option Value' AUTO_INCREMENT=53 ;
...
(39, 5, 0, 'Paul Pairet'),
(40, 5, 1, 'Paul Pairet'),
(41, 7, 0, 'William Saurin'),
(42, 7, 1, 'William Saurin'),
(43, 8, 0, 'Afternoon 2:00-14:30'),
(44, 8, 1, 'Afternoon 2:00-14:30'),
(45, 9, 0, 'Morning 9:00-11:00'),
(46, 9, 1, 'Morning 9:00-11:00'),
(47, 12, 0, '上海'),
(48, 12, 1, 'Shanghai'),
(49, 11, 0, '北京'),
(50, 11, 1, 'Beijing'),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Eav Entity Attributes' AUTO_INCREMENT=481 ;
...
(1, 'catalog_product_attribute', 'require_reindex', '2014-06-28 20:14:14', '2014-06-28 20:14:14', 'real_time'),
(2, 'catalog_product_price', 'require_reindex', '2014-06-28 20:01:28', '2014-06-28 20:01:28', 'real_time'),
(3, 'catalog_url', 'require_reindex', '2014-06-28 20:06:30', '2014-06-28 20:06:30', 'real_time'),
(4, 'catalog_product_flat', 'require_reindex', NULL, NULL, 'real_time'),
(5, 'catalog_category_flat', 'require_reindex', NULL, NULL, 'real_time'),
(6, 'catalog_category_product', 'require_reindex', '2014-06-28 20:06:30', '2014-06-28 20:06:30', 'real_time'),
(7, 'catalogsearch_fulltext', 'require_reindex', '2014-06-28 20:06:30', '2014-06-28 20:06:30', 'real_time'),
(8, 'cataloginventory_stock', 'require_reindex', '2014-06-28 20:01:27', '2014-06-28 20:01:27', 'real_time'),
(9, 'tag_summary', 'require_reindex', '2014-06-28 20:01:28', '2014-06-28 20:01:28', 'real_time');
...
CREATE TABLE IF NOT EXISTS `aca_log_url_info` (
  ...
  PRIMARY KEY (`url_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log URL Info Table' AUTO_INCREMENT=21 ;
...
(3, '1psmhc5u6nsk82h4in8gbrr3a6', '2014-06-28 20:01:44', '2014-06-28 20:14:40', 20, 1);

...
class TM_EasyBanner_Adminhtml_PlaceholderController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('easybanner/adminhtml_placeholder_edit')->setData('action', $this->getUrl('*/*/save')));

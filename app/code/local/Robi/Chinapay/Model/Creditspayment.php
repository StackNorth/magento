...
class Robi_Chinapay_Model_Creditspayment extends Mage_Payment_Model_Method_Abstract
{
	...
	{
		return Mage::getUrl('chinapay/creditpayment/success', array('_secure' => true));
	}
    ...
    {
        return Mage::getUrl('chinapay/creditpayment/error', array('_secure' => true));
    }
	...
	{
		return Mage::getUrl('chinapay/creditpayment/ueronotify', array('_secure' => true));
	}
    ...
    {
        return Mage::getUrl('chinapay/creditpayment/redirect');
    }
    ...
    public function getStandardCheckoutFormFields()
    {
        ...
        $converted_final_price 	= $amount = sprintf('%.2f', $order->getGrandTotal());
		...
		if(!$merid) {
	  	...
	  	$ordid 		= date('Y').sprintf('%012d', $transId);

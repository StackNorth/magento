 ...
 */
class D1m_Core_Model_Encryption extends Mage_Core_Model_Encryption
{
     ...
     *
     * @param int $version
     * @return D1m_Core_Model_Encryption
     */
    ...
    public function validateKey($key)
    {
        if ((false !== strpos($key, '<![CDATA[')) || (false !== strpos($key, ']]>')) || preg_match('/\s/s', $key)) {
            throw new Exception('Encryption key format is invalid.');
        }

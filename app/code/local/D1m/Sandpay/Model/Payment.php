...
class D1m_Sandpay_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
	...
	{
		return Mage::getUrl('sandpay/payment/success', array('_secure' => true));
	}
    ...
    {
        return Mage::getUrl('sandpay/payment/error', array('_secure' => true));
    }
	...
	{
		return Mage::getUrl('sandpay/payment/notify/', array('_secure' => true));
	}
    ...
    {
        $block = $this->getLayout()->createBlock('sandpay/form_payment', $name);
    ...
    {
        return Mage::getUrl('sandpay/payment/redirect');
    }
    ...
    public function getStandardCheckoutFormFields()
    {
        ...
        $currency='156';
        $fronturl=Mage::getUrl('sandpay/payment/success');
        $backurl=Mage::getUrl('sandpay/payment/notify');
        $goods_content='';
        $custom_ip='';

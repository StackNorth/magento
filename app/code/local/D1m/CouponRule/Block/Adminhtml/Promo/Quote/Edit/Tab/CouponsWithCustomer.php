...
class D1m_CouponRule_Block_Adminhtml_Promo_Quote_Edit_Tab_CouponsWithCustomer
...
Mage::helper('logger/data')->info($model->getData());*/
        if ($model->getCouponType() == D1m_CouponRule_Model_Rule::COUPON_TYPE_AUTO_GENERATE_WITH_CUSTOMER){
            return true;
        } else {
            return false;
        }

 ...
 * @author      D1M
 */
class D1m_CouponRule_Adminhtml_CustomerController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function couponAction()
    {
        ...
        $this->getResponse()->setBody($this->getLayout()->createBlock('couponRule/adminhtml_customer_edit_tab_coupon_grid')->toHtml());
    }

<?php
/**
 *  rewrite the coupon generate
 * Class Mage_SalesRule_Model_Coupon_Massgenerator
 */
class D1m_CouponRule_Model_Coupon_Massgenerator extends Mage_SalesRule_Model_Coupon_Massgenerator
{
    /**
    ...
    public function generatePool()
    {
        ...
        for ($i = 0; $i < $size; $i++) {
           ...
           //set from date
           if ($this->getFromDate()){
               $coupon->setBeginUseDate($this->getFromDate());
           }
            //save the coupon type
           if ($this->getCouponType()){
               if ($this->getCouponType() == Mage_SalesRule_Model_Rule::COUPON_TYPE_SPECIFIC) {
                   $coupon ->setType(Mage_SalesRule_Helper_Coupon::COUPON_TYPE_SPECIFIC_AUTOGENERATED);
               } else {
                   $coupon ->setType($this->getCouponType());
               }
           } else {
               $coupon ->setType(Mage_SalesRule_Helper_Coupon::COUPON_TYPE_SPECIFIC_AUTOGENERATED);
           }
    ...
    {
        return !empty($data) && !empty($data['rule_id'])

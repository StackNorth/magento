 ...
 * http://www.geetest.com/install/sections/idx-server-sdk.html
 * @author
 */
class D1m_GeeTest_Model_Util
{
    public $response_str;
    ...
    {
		$this->captcha_id = $this->getCaptchaId();
		$this->private_key = $this->getPrivateKey();
	}

	public function getCaptchaId()
	{
		if(Mage::helper('d1m_geeTest')->isMobileBrowser())
		{
			return Mage::getModel('d1m_geeTest/config')->getMAccountConfig('captcha_id');
		}
		return Mage::getModel('d1m_geeTest/config')->getAccountConfig('captcha_id');
	}
	...
	public function getPrivateKey()
	{
		if(Mage::helper('d1m_geeTest')->isMobileBrowser())
		{
			return Mage::getModel('d1m_geeTest/config')->getMAccountConfig('private_key');
		}
		return Mage::getModel('d1m_geeTest/config')->getAccountConfig('private_key');
	}

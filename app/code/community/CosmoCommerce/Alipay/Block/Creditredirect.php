 ...
 */
class CosmoCommerce_Alipay_Block_Creditredirect extends Mage_Core_Block_Abstract
{
	...
	protected function _toHtml()
	{
        ...
        foreach ($standard->setCreditOrder($this->getCreditOrder())->getCreditOrderStandardCheckoutFormFields() as $field => $value) {
